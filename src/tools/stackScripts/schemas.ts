...
export const listStackScriptsSchema = z.object({
  ...
  is_mine: coerceBoolean().optional().describe('Only return StackScripts created by your account'),
  is_public: coerceBoolean().optional().describe('If true, returns only public StackScripts'),
});
...
export const getStackScriptSchema = z.object({
  id: z.coerce.number().describe('The ID of the StackScript')
});
