...
export const getDomainSchema = z.object({
  id: z.coerce.number().describe('The ID of the domain')
});
...
export const createDomainSchema = z.object({
  ...
  ttl_sec: z.coerce.number().optional().describe('Time to Live (TTL) for the domain, in seconds'),
  refresh_sec: z.coerce.number().optional().describe('The refresh interval for the domain, in seconds'),
  retry_sec: z.coerce.number().optional().describe('The retry interval for the domain, in seconds'),
  expire_sec: z.coerce.number().optional().describe('The expiry time for the domain, in seconds'),
  tags: tagsSchema
});
...
export const listDomainRecordsSchema = z.object({
  domainId: z.coerce.number().describe('The ID of the domain'),
  ...pagingParamsSchema.shape
});

export const getDomainRecordSchema = z.object({
  domainId: z.coerce.number().describe('The ID of the domain'),
  recordId: z.coerce.number().describe('The ID of the record')
});
...
export const createDomainRecordSchema = z.object({
  ...
  priority: z.coerce.number().optional().describe('The priority of this record (required for MX and SRV records)'),
  weight: z.coerce.number().optional().describe('The weight for this record (required for SRV records)'),
  port: z.coerce.number().optional().describe('The port this record points to (required for SRV records)'),
  ...
  ttl_sec: z.coerce.number().optional().describe('Time to Live (TTL) for this record, in seconds'),
...
export const updateDomainRecordSchema = z.object({
  ...
  priority: z.coerce.number().optional().describe('The priority of this record'),
  weight: z.coerce.number().optional().describe('The weight for this record'),
  port: z.coerce.number().optional().describe('The port this record points to'),
...
export const cloneDomainSchema = z.object({
  id: z.coerce.number().describe('The ID of the source domain to clone'),
