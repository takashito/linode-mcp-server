...
import { createClient, LinodeClient, Domain, DomainRecord } from '../../client';
...
export function registerDomainTools(server: FastMCP, client: LinodeClient) {
  ...
  server.addTool({
    ...
    execute: withErrorHandling(async (params: any, context?: any) => {
      const result = await createClient(context, server).domains.getDomains(params);
  ...
  server.addTool({
    ...
    execute: withErrorHandling(async (params: any, context?: any) => {
      const result = await createClient(context, server).domains.getDomain(params.id);
  ...
  server.addTool({
    ...
    execute: withErrorHandling(async (params: any, context?: any) => {
      const result = await createClient(context, server).domains.createDomain(params);
      return formatDomain(result);
    })
  });
  server.addTool({
    ...
    execute: withErrorHandling(async (params: any, context?: any) => {
      ...
      const result = await createClient(context, server).domains.updateDomain(id, data);
      return formatDomain(result);
    })
  });
  server.addTool({
    ...
    execute: withErrorHandling(async (params: any, context?: any) => {
      await createClient(context, server).domains.deleteDomain(params.id);
  ...
  server.addTool({
    ...
    execute: withErrorHandling(async (params: any, context?: any) => {
      const result = await createClient(context, server).domains.getZoneFile(params.id);
  ...
  server.addTool({
    ...
    execute: withErrorHandling(async (params: any, context?: any) => {
      const result = await createClient(context, server).domains.getDomainRecords(params.id, {
        page: params.page,
  ...
  server.addTool({
    ...
    execute: withErrorHandling(async (params: any, context?: any) => {
      const result = await createClient(context, server).domains.getDomainRecord(params.domainId, params.recordId);
  ...
  server.addTool({
    ...
    execute: withErrorHandling(async (params: any, context?: any) => {
      ...
      const result = await createClient(context, server).domains.createDomainRecord(domainId, data);
      return formatDomainRecord(result);
    })
  });
  server.addTool({
    ...
    execute: withErrorHandling(async (params: any, context?: any) => {
      ...
      const result = await createClient(context, server).domains.updateDomainRecord(domainId, recordId, data);
      return formatDomainRecord(result);
    })
  });
  server.addTool({
    ...
    execute: withErrorHandling(async (params: any, context?: any) => {
      await createClient(context, server).domains.deleteDomainRecord(params.domainId, params.recordId);
      return JSON.stringify({ success: true }, null, 2);
    })
  });
  ...
  server.addTool({
    ...
    execute: withErrorHandling(async (params: any, context?: any) => {
      const result = await createClient(context, server).domains.importZone(params);
      return formatDomain(result);
    })
  });
  server.addTool({
    ...
    execute: withErrorHandling(async (params: any, context?: any) => {
      ...
      const result = await createClient(context, server).domains.cloneDomain(id, { domain });
      return formatDomain(result);
    })
  });
}