...
import { createClient, LinodeClient, ObjectStorageBucket, ObjectStorageCluster, ObjectStorageKey, ObjectStorageObject } from '../../client';
...
export function registerObjectStorageTools(server: FastMCP, client: LinodeClient) {
  ...
  server.addTool({
    ...
    execute: withErrorHandling(async (params: any, context?: any) => {
      const clusters = await createClient(context, server).objectStorage.getClusters();
      return {
        content: [
  ...
  server.addTool({
    ...
    execute: withErrorHandling(async (params: any, context?: any) => {
      const result = await createClient(context, server).objectStorage.getEndpoints(params);
      return {
        content: [
  ...
  server.addTool({
    ...
    execute: withErrorHandling(async (params: any, context?: any) => {
      const result = await createClient(context, server).objectStorage.getBuckets(params);
      return {
        content: [
  ...
  server.addTool({
    ...
    execute: withErrorHandling(async (params: any, context?: any) => {
      ...
      const result = await createClient(context, server).objectStorage.getBucket(
        params.region, 
  ...
  server.addTool({
    ...
    execute: withErrorHandling(async (params: any, context?: any) => {
      ...
      const result = await createClient(context, server).objectStorage.createBucket(createParams);
      return {
        content: [
          { type: 'text', text: formatObjectStorageBucket(result) },
        ],
  ...
  server.addTool({
    ...
    execute: withErrorHandling(async (params: any, context?: any) => {
      ...
      await createClient(context, server).objectStorage.deleteBucket(region, bucket);
      return {
        content: [
  ...
  server.addTool({
    ...
    execute: withErrorHandling(async (params: any, context?: any) => {
      const { region, bucket, ...data } = params;
      const result = await createClient(context, server).objectStorage.getBucketAccess(region, bucket);
      return {
        content: [
...
CORS Enabled: ${result.cors_enabled ? 'Yes' : 'No'}` },
  ...
  server.addTool({
    ...
    execute: withErrorHandling(async (params: any, context?: any) => {
      const { region, bucket, ...data } = params;
      const result = await createClient(context, server).objectStorage.updateBucketAccess(region, bucket, data);
      return {
        content: [
...
CORS Enabled: ${result.cors_enabled ? 'Yes' : 'No'}` },
  ...
  server.addTool({
    ...
    execute: withErrorHandling(async (params: any, context?: any) => {
      ...
      const result = await createClient(context, server).objectStorage.getObjects(region, bucket, paginationParams);
      return {
        content: [
  ...
  server.addTool({
    ...
    execute: withErrorHandling(async (params: any, context?: any) => {
        const result = await createClient(context, server).objectStorage.getBucketCertificate(params.region, params.bucket);
        return {
          content: [
...
Expires: ${new Date(result.expiry).toLocaleString()}` },
  ...
  server.addTool({
    ...
    execute: withErrorHandling(async (params: any, context?: any) => {
      ...
      const result = await createClient(context, server).objectStorage.uploadBucketCertificate(region, bucket, {
        certificate,
        private_key,
      });
      return {
...
Expires: ${new Date(result.expiry).toLocaleString()}` },
  ...
  server.addTool({
    ...
    execute: withErrorHandling(async (params: any, context?: any) => {
      await createClient(context, server).objectStorage.deleteBucketCertificate(params.region, params.bucket);
      return {
        content: [
  ...
  server.addTool({
    ...
    execute: withErrorHandling(async (params: any, context?: any) => {
      const result = await createClient(context, server).objectStorage.getKeys(params);
      return {
        content: [
  ...
  server.addTool({
    ...
    execute: withErrorHandling(async (params: any, context?: any) => {
      const result = await createClient(context, server).objectStorage.getKey(params.id);
      return {
        content: [
  ...
  server.addTool({
    ...
    execute: withErrorHandling(async (params: any, context?: any) => {
      const result = await createClient(context, server).objectStorage.createKey(params);
      return {
        content: [
          { type: 'text', text: formatObjectStorageKey(result) },
        ],
  ...
  server.addTool({
    ...
    execute: withErrorHandling(async (params: any, context?: any) => {
      ...
      const result = await createClient(context, server).objectStorage.updateKey(id, updateData);
      return {
        content: [
          { type: 'text', text: formatObjectStorageKey(result) },
        ],
  ...
  server.addTool({
    ...
    execute: withErrorHandling(async (params: any, context?: any) => {
      await createClient(context, server).objectStorage.deleteKey(params.id);
      return {
        content: [
  ...
  server.addTool({
    ...
    execute: withErrorHandling(async (params: any, context?: any) => {
      const result = await createClient(context, server).objectStorage.getDefaultBucketAccess();
      return {
        content: [
...
CORS Enabled: ${result.cors_enabled ? 'Yes' : 'No'}` },
  ...
  server.addTool({
    ...
    execute: withErrorHandling(async (params: any, context?: any) => {
      const result = await createClient(context, server).objectStorage.updateDefaultBucketAccess(params);
      return {
        content: [
...
CORS Enabled: ${result.cors_enabled ? 'Yes' : 'No'}` },
  ...
  server.addTool({
    ...
    execute: withErrorHandling(async (params: any, context?: any) => {
      ...
      await createClient(context, server).objectStorage.updateObjectACL(region, bucket, name, { acl });
      return {
        content: [
  ...
  server.addTool({
    ...
    execute: withErrorHandling(async (params: any, context?: any) => {
      ...
      const result = await createClient(context, server).objectStorage.getObjectURL(region, bucket, apiParams);
      return {
        content: [
...
Note: This URL is temporary and will expire after ${params.expires_in || 3600} seconds.` },
  ...
  server.addTool({
    ...
    execute: withErrorHandling(async (params: any, context?: any) => {
      ...
      const urlResult = await createClient(context, server).objectStorage.getObjectURL(region, bucket, {
        name: object_path,
        method: 'PUT',
      ...
      // Set ACL if provided
      if (acl) {
        await createClient(context, server).objectStorage.updateObjectACL(region, bucket, object_path, { acl });
      }
...
ACL: ${acl || 'Default bucket ACL'}` },
  ...
  server.addTool({
    ...
    execute: withErrorHandling(async (params: any, context?: any) => {
      ...
      const result = await createClient(context, server).objectStorage.getObjectURL(region, bucket, {
        name: object_path,
        method: 'GET',
        expires_in: expires_in || 3600
      });
...
Content Type: ${getContentType(object_path)}` },
  ...
  server.addTool({
    ...
    execute: withErrorHandling(async (params: any, context?: any) => {
      const result = await createClient(context, server).objectStorage.getTransferStats();
      return {
        content: [
  ...
  server.addTool({
    ...
    execute: withErrorHandling(async (params: any, context?: any) => {
      const result = await createClient(context, server).objectStorage.getTypes();
      return {
        content: [
  ...
  server.addTool({
    ...
    execute: withErrorHandling(async (params: any, context?: any) => {
      await createClient(context, server).objectStorage.cancelObjectStorage();
      return {
        content: [
