...
import { createClient, LinodeClient, DatabaseEngine, DatabaseType, DatabaseInstance, MySQLDatabaseInstance, DatabaseCredentials, SSLCertificate } from '../../client';
...
export function registerDatabaseTools(server: FastMCP, client: LinodeClient) {
  ...
  server.addTool({
    ...
    execute: withErrorHandling(async (params: any, context?: any) => {
      const result = await createClient(context, server).databases.getEngines(params);
  ...
  server.addTool({
    ...
    execute: withErrorHandling(async (params: any, context?: any) => {
      const result = await createClient(context, server).databases.getEngine(params.engineId);
  ...
  server.addTool({
    ...
    execute: withErrorHandling(async (params: any, context?: any) => {
      const result = await createClient(context, server).databases.getTypes(params);
  ...
  server.addTool({
    ...
    execute: withErrorHandling(async (params: any, context?: any) => {
      const result = await createClient(context, server).databases.getType(params.typeId);
  ...
  server.addTool({
    ...
    execute: withErrorHandling(async (params: any, context?: any) => {
      const result = await createClient(context, server).databases.getDatabaseInstances(params);
  ...
  server.addTool({
    ...
    execute: withErrorHandling(async (params: any, context?: any) => {
      const result = await createClient(context, server).databases.getMySQLInstances(params);
      return formatDatabaseInstances(result.data);
    })
  });
  server.addTool({
    ...
    execute: withErrorHandling(async (params: any, context?: any) => {
      const result = await createClient(context, server).databases.getMySQLInstance(params.instanceId);
  ...
  server.addTool({
    ...
    execute: withErrorHandling(async (params: any, context?: any) => {
      const result = await createClient(context, server).databases.createMySQLInstance(params);
      return formatDatabaseInstance(result);
    })
  });
  server.addTool({
    ...
    execute: withErrorHandling(async (params: any, context?: any) => {
      ...
      const result = await createClient(context, server).databases.updateMySQLInstance(instanceId, data);
      return formatDatabaseInstance(result);
    })
  });
  server.addTool({
    ...
    execute: withErrorHandling(async (params: any, context?: any) => {
      await createClient(context, server).databases.deleteMySQLInstance(params.instanceId);
  ...
  server.addTool({
    ...
    execute: withErrorHandling(async (params: any, context?: any) => {
      const result = await createClient(context, server).databases.getMySQLCredentials(params.instanceId);
  ...
  server.addTool({
    ...
    execute: withErrorHandling(async (params: any, context?: any) => {
      const result = await createClient(context, server).databases.resetMySQLCredentials(params.instanceId);
      return formatDatabaseCredentials(result);
    })
  });
  server.addTool({
    ...
    execute: withErrorHandling(async (params: any, context?: any) => {
      const result = await createClient(context, server).databases.getMySQLSSLCertificate(params.instanceId);
  ...
  server.addTool({
    ...
    execute: withErrorHandling(async (params: any, context?: any) => {
      await createClient(context, server).databases.patchMySQLInstance(params.instanceId);
      return JSON.stringify({ success: true }, null, 2);
    })
  });
  server.addTool({
    ...
    execute: withErrorHandling(async (params: any, context?: any) => {
      await createClient(context, server).databases.suspendMySQLInstance(params.instanceId);
      return JSON.stringify({ success: true }, null, 2);
    })
  });
  server.addTool({
    ...
    execute: withErrorHandling(async (params: any, context?: any) => {
      await createClient(context, server).databases.resumeMySQLInstance(params.instanceId);
      return JSON.stringify({ success: true }, null, 2);
    })
  });
  ...
  server.addTool({
    ...
    execute: withErrorHandling(async (params: any, context?: any) => {
      const result = await createClient(context, server).databases.getPostgreSQLInstances(params);
      return formatDatabaseInstances(result.data);
    })
  });
  server.addTool({
    ...
    execute: withErrorHandling(async (params: any, context?: any) => {
      const result = await createClient(context, server).databases.getPostgreSQLInstance(params.instanceId);
      return formatDatabaseInstance(result);
    })
  });
  server.addTool({
    ...
    execute: withErrorHandling(async (params: any, context?: any) => {
      const result = await createClient(context, server).databases.createPostgreSQLInstance(params);
      return formatDatabaseInstance(result);
    })
  });
  server.addTool({
    ...
    execute: withErrorHandling(async (params: any, context?: any) => {
      const { instanceId, ...data } = params;
      const result = await createClient(context, server).databases.updatePostgreSQLInstance(instanceId, data);
      return formatDatabaseInstance(result);
    })
  });
  server.addTool({
    ...
    execute: withErrorHandling(async (params: any, context?: any) => {
      await createClient(context, server).databases.deletePostgreSQLInstance(params.instanceId);
      return JSON.stringify({ success: true }, null, 2);
    })
  });
  server.addTool({
    ...
    execute: withErrorHandling(async (params: any, context?: any) => {
      const result = await createClient(context, server).databases.getPostgreSQLCredentials(params.instanceId);
      return formatDatabaseCredentials(result);
    })
  });
  server.addTool({
    ...
    execute: withErrorHandling(async (params: any, context?: any) => {
      const result = await createClient(context, server).databases.resetPostgreSQLCredentials(params.instanceId);
      return formatDatabaseCredentials(result);
    })
  });
  server.addTool({
    ...
    execute: withErrorHandling(async (params: any, context?: any) => {
      const result = await createClient(context, server).databases.getPostgreSQLSSLCertificate(params.instanceId);
      return formatSSLCertificate(result);
    })
  });
  server.addTool({
    ...
    execute: withErrorHandling(async (params: any, context?: any) => {
      await createClient(context, server).databases.patchPostgreSQLInstance(params.instanceId);
      return JSON.stringify({ success: true }, null, 2);
    })
  });
  server.addTool({
    ...
    execute: withErrorHandling(async (params: any, context?: any) => {
      await createClient(context, server).databases.suspendPostgreSQLInstance(params.instanceId);
      return JSON.stringify({ success: true }, null, 2);
    })
  });
  server.addTool({
    ...
    execute: withErrorHandling(async (params: any, context?: any) => {
      await createClient(context, server).databases.resumePostgreSQLInstance(params.instanceId);
      return JSON.stringify({ success: true }, null, 2);
    })
  });
}